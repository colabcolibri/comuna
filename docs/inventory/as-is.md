...
| Seed multi-comunidade + pessoas + catálogo | `scripts/seed/communities.cjs`, `demo-people.cjs`, `directory-catalog.cjs`, `membership-cards.cjs` | high | dados | Hospitalidade só na comunidade demo (campo extra) |
