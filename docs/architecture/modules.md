...
4. Comunidade nova e seed: todos os first-party (`directory`, `showcase`, `contact-mediated`, `map`) nascem `enabled = true` (insert, não o DEFAULT da coluna). Off = a app **não mostra** nada daquele slug.
