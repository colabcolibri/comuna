      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex min-w-0 flex-wrap items-center gap-2 sm:justify-end">
          ...
          <OpsSheet
            ...
            trigger={
              <OpsIconButton label={copy.edit}>
                <Pencil />
              </OpsIconButton>
            }
            title={pickLocalizedText(field.label, locale) || field.name}
            description={field.locked ? copy.lockedHint : undefined}
          ...
          >
            ...
            <div className="grid min-w-0 gap-4">
              <div className="min-w-0 space-y-2">
                <Label htmlFor={`ops-field-desc-pt-${field.id}`}>{copy.descriptionPt}</Label>
                <Textarea
                  id={`ops-field-desc-pt-${field.id}`}
                  value={descriptionPt}
              ...
              <div className="min-w-0 space-y-2">
                <Label htmlFor={`ops-field-desc-en-${field.id}`}>{copy.descriptionEn}</Label>
                <Textarea
                  id={`ops-field-desc-en-${field.id}`}
                  value={descriptionEn}
          ...
          <OpsIconButton
            label={field.enabled ? copy.deactivate : copy.activate}
            onClick={() => void setEnabled(!field.enabled)}
          >
            {field.enabled ? <EyeOff /> : <Eye />}
          </OpsIconButton>
